          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="(item,index) in spuSaleAttrList" :key="item.id">
                ...
                <dd @click='changeActive(value,item.spuSaleAttrValueList)' v-for="(value,index1) in item.spuSaleAttrValueList" :key="value.id" :class="{active:value.isChecked == 1}">{{ value.saleAttrValueName }}</dd>
              </dl>
            </div>
            <div class="cartWrap">
              <div class="controls">
                <input autocomplete="off" class="itxt" @change="changNum" v-model="skuNum" >
                <a href="javascript:" @click="skuNum++" class="plus">+</a>
                <a href="javascript:" @click="skuNum>1?skuNum--:0" class="mins">-</a>
              </div>
              <div class="add">
...
<script>
  ...
  export default {
    ...
    methods:{
      ...
      async addShopCar(){
       try {
        await this.$store.dispatch("postAddShopCar",{skuId:this.$route.params.skuid,skuNum:this.skuNum})
