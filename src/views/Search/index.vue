      ...
      <div class="py-container">
        ...
        <div class="bread">
          ...
          <ul class="fl sui-tag">
            ...
            <li class="with-x" v-for="(item,index) in searchParams.props" :key="item.id">{{item.split(':')[1]}}<i @click="removeProps(index)">✖</i></li>
          </ul>
        </div>
        ...
        <div class="details clearfix">
          <div class="sui-navbar">
            <div class="navbar-inner filter">
              <ul class="sui-nav">
                <li @click="changeOrder('1')" :class="{active:isOne,active:isCur == 1}">
                  <a>综合</a>
                </li>
                <li @click="changeOrder('2')" :class="{active:isTwo,active:isCur == 2}">
                  <a>价格</a>
                </li>
              </ul>
            </div>
...
<script>
  ...
  export default {
    ...
    methods:{
      getData(){
        this.$store.dispatch('postSearchInfo',this.searchParams)
      },
      removeKeyWord(){
