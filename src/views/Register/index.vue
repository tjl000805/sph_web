<template>
  <div class="register-container">
    ...
    <div class="register">
      ...
      <div class="content">
        <label>确认密码:</label>
        <input v-model="surePwd" type="password" placeholder="请输入确认密码">
        <span class="error-msg">错误提示信息</span>
      </div>
      <div class="controls">
...
export default {
  ...
  methods: {
   ...
   async register(){
      try {
        const {phone,password,surePwd,code} = this;
        (phone && code && password == surePwd) && await this.$store.dispatch('toRegister',{phone,code,password})
